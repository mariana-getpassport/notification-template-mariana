...
# source: v1/recommendations.proto
...
_RECOMMENDATIONREQUEST = _descriptor.Descriptor(
  ...
  full_name='package_grpc.v1.RecommendationRequest',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='user_id', full_name='package_grpc.v1.RecommendationRequest.user_id', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='category', full_name='package_grpc.v1.RecommendationRequest.category', index=1,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='max_results', full_name='package_grpc.v1.RecommendationRequest.max_results', index=2,
...
_BOOKRECOMMENDATION = _descriptor.Descriptor(
  ...
  full_name='package_grpc.v1.BookRecommendation',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='id', full_name='package_grpc.v1.BookRecommendation.id', index=0,
      number=1, type=5, cpp_type=1, label=1,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='title', full_name='package_grpc.v1.BookRecommendation.title', index=1,
...
_RECOMMENDATIONRESPONSE = _descriptor.Descriptor(
  ...
  full_name='package_grpc.v1.RecommendationResponse',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='recommendations', full_name='package_grpc.v1.RecommendationResponse.recommendations', index=0,
...
RecommendationRequest = _reflection.GeneratedProtocolMessageType('RecommendationRequest', (_message.Message,), {
  ...
  '__module__' : 'v1.recommendations_pb2'
  # @@protoc_insertion_point(class_scope:package_grpc.v1.RecommendationRequest)
  })
...
BookRecommendation = _reflection.GeneratedProtocolMessageType('BookRecommendation', (_message.Message,), {
  ...
  '__module__' : 'v1.recommendations_pb2'
  # @@protoc_insertion_point(class_scope:package_grpc.v1.BookRecommendation)
  })
...
RecommendationResponse = _reflection.GeneratedProtocolMessageType('RecommendationResponse', (_message.Message,), {
  ...
  '__module__' : 'v1.recommendations_pb2'
  # @@protoc_insertion_point(class_scope:package_grpc.v1.RecommendationResponse)
  })
...
_RECOMMENDATIONS = _descriptor.ServiceDescriptor(
  ...
  full_name='package_grpc.v1.Recommendations',
  file=DESCRIPTOR,
  index=0,
  serialized_options=None,
  create_key=_descriptor._internal_create_key,
  ...
  _descriptor.MethodDescriptor(
    name='Recommend',
    full_name='package_grpc.v1.Recommendations.Recommend',
    index=0,
